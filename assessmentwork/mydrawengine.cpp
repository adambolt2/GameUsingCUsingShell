...
// Modified by W20000343
// Allow my drawengine to be able to scale objects horizontally and vertically
...

{
	...
	return DrawAt(position, pic, scale, scale, angle, transparency);
