...
// Modified 13/05/2023 by W20000343
// CPP overload to accept X and Y values for image resolution
...
public:
	...
	ErrorType DrawAt(Vector2D position, PictureIndex pic, float scalex , float scaley , float angle , float transparency );
